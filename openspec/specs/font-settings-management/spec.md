# font-settings-management Specification

## Purpose
TBD - created by syncing change add-font-settings. Update Purpose after archive.
...
- **WHEN** the unified settings document or its font section does not exist
